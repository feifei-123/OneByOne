...
/**
 *“当天”小方格的  “圆圈”显示图层 的背景图片
 *added by feifei  2015_06_12
 */
@property (nonatomic) UIImage *dayCircleTodayImage;

/**
 *“其他月 当天”小方格的  “圆圈”显示图层 的背景图片
 *added by feifei  2015_06_12
 */
@property (nonatomic) UIImage *dayCircleTodayOtherMonthImage;

/**
 *“选中状态”小方格的  “圆圈”显示图层 的背景图片
 *added by feifei  2015_06_12
 */
@property (nonatomic) UIImage *dayCircleSelectedImage;

/**
 *“选中状态”其他月份的小方格的  “圆圈”显示图层 的背景图片
 *added by feifei  2015_06_12
 */
@property (nonatomic) UIImage *dayCircleSelectedOtherMonthImage;
...
//------------------added by feifei 2015_06_25
/**
 * 当月小圆点的默认图片
 */
@property (nonatomic) UIImage *dayDotImage;

/**
 *	当月 小圆点选中状态的图片
 */

@property (nonatomic) UIImage *dayDotImageSelected;

/**
 * 其他月份  小圆点的默认图片
 */
@property (nonatomic) UIImage *dayDotImageOtherMonth;

/**
 *	其他月份 小圆点选中状态的图片
 */
@property (nonatomic) UIImage *dayDotImageSelectedOtherMonth;

/**
 *	当天 小圆点的图片
 */
@property (nonatomic) UIImage *dayDotImageToday;

/**
 *	其他月份 当天 小圆点的图片
 */
@property (nonatomic) UIImage *dayDotImageTodayOtherMonth;
...
/**
 *	日历小方格的 “背景图片” added by feifei
 */
@property (nonatomic) UIImage *dayBackgroundImage;
